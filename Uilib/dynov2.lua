do
	local gui = game.Players.LocalPlayer.PlayerGui:FindFirstChild("HovxrzGui")
	if gui then
		gui:Destroy()
	end
end
...
function library:CreateWindow(text,maincolor,text2,logo)
	...
	function uitab:AddTab(text)
		...
		function main:AddToggle(text,config,callback)
			...
			Frame.Position = UDim2.new(0.902999997, 0, 0.492647111, 0)
			Frame.Size = UDim2.new(0, 40, 0, 19)

			UICorner.CornerRadius = UDim.new(0, 3192)
			...
			Frame_2.Position = UDim2.new(0.28, 0,0.5, 0)
		...
		function main:AddSeperator(text)
			...
			UIGradient.Transparency = NumberSequence.new{NumberSequenceKeypoint.new(0.00, 1.00), NumberSequenceKeypoint.new(0.10, 0.63), NumberSequenceKeypoint.new(0.50, 0.39), NumberSequenceKeypoint.new(0.90, 0.61), NumberSequenceKeypoint.new(1.00, 1.00)}
			UIGradient.Parent = Sep1
			...
			UIGradient_2.Transparency = NumberSequence.new{NumberSequenceKeypoint.new(0.00, 1.00), NumberSequenceKeypoint.new(0.10, 0.63), NumberSequenceKeypoint.new(0.50, 0.39), NumberSequenceKeypoint.new(0.90, 0.61), NumberSequenceKeypoint.new(1.00, 1.00)}
			UIGradient_2.Parent = Sep3
		end
