...
loadstring(request({Url="https://raw.githubusercontent.com/Kelv1v/Unit_Hub/main/Modules/InstanceProtect.lua",Method="GET"}).Body)()
local UIS = game:GetService("UserInputService")
local TS = game:GetService("TweenService")
Color = _G.Edit["Color"] or Color3.fromRGB(135, 255, 135)
function library:CreateWindow(name, version, icon)
	...
	TitleUnderline.BackgroundColor3 = Color
	...
	function tabs:CreateTab(name)
		...
		function mytabbuttons:CreateFrame(name)
			...
			function pagebuttons:CreateLabel(name)
				...
				_4pxShadow2px.ImageColor3 = Color
			...
			function pagebuttons:CreateSlider(name,min,max,callback)
				...
				Indicator_3.BackgroundColor3 = Color
			...
			function pagebuttons:CreateBox(name, icon, callback)
				...
				Footer_3.BackgroundColor3 = Color
			...
			function pagebuttons:CreateBind(name, defaultkey, callback)
				...
				Footer_2.BackgroundColor3 = Color
