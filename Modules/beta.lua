...
wait()
do Combat =  getupvalue(require(Client.PlayerScripts.CombatFramework),2);RL = require(game:GetService("ReplicatedStorage").CombatFramework.RigLib);PC = require(Client.PlayerScripts.CombatFramework.Particle);DMG = require(Client.PlayerScripts.CombatFramework.Particle.Damage);RigC = getupvalue(require(Client.PlayerScripts.CombatFramework.RigController),2);end
do
canHits = {}
...
end;--local Radius = (DamageAura and Settings.DamageAuraRadius) or 65
...
RigEvent.FireServer(RigEvent,"hit",canHits,AID3 and 3 or 2,"");-- AttackSignal:Fire()
delay(.5,function()
Playing:Stop()
end)
end
